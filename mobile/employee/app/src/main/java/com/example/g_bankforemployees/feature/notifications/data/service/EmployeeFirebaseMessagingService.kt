...
import com.example.g_bankforemployees.common.presentation.MainActivity
...
class EmployeeFirebaseMessagingService : FirebaseMessagingService(), KoinComponent {

    private val notificationTokenSyncManager: NotificationTokenSyncManager by inject()
    ...
    private fun showNotification(message: RemoteMessage) {
        ...
        val notification = NotificationCompat.Builder(this, EMPLOYEE_NOTIFICATION_CHANNEL_ID)
